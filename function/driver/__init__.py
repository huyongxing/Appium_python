...
class Driver():
    def __init__(self):
        self.driver_path = root_path + "Appium_python\\function\\driver\\chromedriver.exe"
...
def upload_image(file_dir, file_name):
    time.sleep(0.5)
    up_load_path = root_path + "Appium_python\\function\\driver\\upimage.exe"
...
if __name__ == '__main__':
    browser = Driver()
    url = "http://huyx-web-linry.beta.saasyc.com"
